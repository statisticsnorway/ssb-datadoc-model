...
public class Variable implements Serializable
{
    ...
    private no.ssb.dapla.metadata.Dataset.TemporalityTypeType temporalityType;
    /**
     * Measurement unit
     * <p>
    ...
    private final static long serialVersionUID = 2872479931329103403L;
     ...
     */
    public Variable(String shortName, LanguageStringType name, Variable.DataType dataType, Variable.VariableRole variableRole, URI definitionUri, Boolean directPersonIdentifying, LanguageStringType dataSource, LanguageStringType populationDescription, LanguageStringType comment, no.ssb.dapla.metadata.Dataset.TemporalityTypeType temporalityType, String measurementUnit, String format, URI classificationUri, URI sentinelValueUri, LanguageStringType invalidValueDescription, UUID id, Date containsDataFrom, Date containsDataUntil) {
        super();
     ...
     */
    @JsonProperty("temporality_type")
    public no.ssb.dapla.metadata.Dataset.TemporalityTypeType getTemporalityType() {
     ...
     */
    @JsonProperty("temporality_type")
    public void setTemporalityType(no.ssb.dapla.metadata.Dataset.TemporalityTypeType temporalityType) {
        this.temporalityType = temporalityType;
    }
