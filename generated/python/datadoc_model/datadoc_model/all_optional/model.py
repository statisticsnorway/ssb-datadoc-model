...
#   timestamp: 2026-08-26T11:43:54+00:00
...
class DatadocMetadata(DatadocBaseModel):
    ...
    document_version: Literal["6.2.0"] | None = Field(
        None, description="Version of this model"
    )
...
class MetadataContainer(DatadocBaseModel):
    document_version: Literal["1.0.0"] | None = None
